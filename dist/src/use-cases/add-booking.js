...
var AddBooking = /** @class */ (function () {
    function AddBooking(bookingForm) {
     ...
     */
    AddBooking.prototype.execute = function () {
        return __awaiter(this, void 0, void 0, function () {
            var hotel, booking;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, typedi_1.Container.get(google_place_api_wrapper_1.GooglePlaceApiWrapper).getPlaceById(this._bookingForm.get("hotelId"))];
                    case 1:
                        hotel = _a.sent();
                        if (!hotel) {
                            throw new Error("Could not find the hotel with this id: " + this._bookingForm.get("hotelId"));
                        }
                        ...
                        return [4 /*yield*/, typedi_1.Container.get(booking_repository_1.BookingRepository).saveBooking(booking)];
