...
var find_hotel_bookings_1 = require("../src/use-cases/find-hotel-bookings");
var hotel_service_1 = require("../src/services/hotel-service");
var add_booking_form_1 = require("../src/add-booking-form");
describe("Booking Tests", function () {
    var apiKey = process.env.GOOGLE_API_KEY;
    var hotelId = "ChIJN1t_tDeuEmsRUsoyG83frY4";
    it("should find bookings of a hotel", function () { return __awaiter(void 0, void 0, void 0, function () {
        var mock, bookings;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, typedi_1.Container.get(hotel_service_1.HotelService).addBooking(new add_booking_form_1.AddBookingForm({
                            hotelId: hotelId,
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, new find_hotel_bookings_1.FindHotelBookings(hotelId).execute()];
                case 2:
                    bookings = _a.sent();
                    chai_1.expect(bookings.length).to.be.gte(1);
                    return [2 /*return*/];
            }
        });
    }); });
