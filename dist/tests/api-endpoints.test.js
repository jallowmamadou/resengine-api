...
describe("Test API Endpoints", function () {
    ...
    it("should POST  /api/hotels/{hotelId}/bookings", function () { return __awaiter(void 0, void 0, void 0, function () {
        var mock, formData, response, responseBody;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mock = new axios_mock_adapter_1.default(axios_1.default);
                    ...
                    return [4 /*yield*/, supertest_1.agent(app_1.app)
                ...
                case 1:
                    ...
                    chai_1.expect(responseBody).to.have.property("links");
                    chai_1.expect(responseBody).to.have.property("meta");
                    chai_1.expect(responseBody.data).to.contain({
    ...
    it("should GET  /api/hotels/{hotelId}/bookings", function () { return __awaiter(void 0, void 0, void 0, function () {
        var mock, response, responseBody;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    mock
                        ...
                        .reply(200, place_details_data_1.PlaceDetails);
                    typedi_1.Container.set(google_place_api_wrapper_1.GooglePlaceApiWrapper, new google_place_api_wrapper_1.GooglePlaceApiWrapper(new http_service_1.HttpService().setClient(axios_1.default)));
                    return [4 /*yield*/, supertest_1.agent(app_1.app).get("/api/hotels/" + hotelId + "/bookings")];
                case 1:
                    response = _a.sent();
                    responseBody = response.body;
                    chai_1.expect(responseBody).to.have.property("data");
