...
var search_hotels_nearby_1 = require("../src/use-cases/search-hotels-nearby");
describe("Hotel Tests", function () {
    var apiKey = process.env.GOOGLE_API_KEY;
    it("should find hotels hear coordinates", function () { return __awaiter(void 0, void 0, void 0, function () {
        var mock, hotels;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, new search_hotels_nearby_1.SearchHotelsNearby(48.19851972979718, 11.512284425816313).execute()];
                case 1:
                    hotels = _a.sent();
                    chai_1.expect(hotels.length).to.be.gte(1);
                    return [2 /*return*/];
            }
        });
    }); });
});
//# sourceMappingURL=hotel.test.js.map