...
var Hotel_booking_controller_1 = require("../src/controllers/Hotel-booking-controller");
describe("HotelBookingController test", function () {
    it("should create a new booking", function () { return __awaiter(void 0, void 0, void 0, function () {
        var mock, controller, store;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    controller = new Hotel_booking_controller_1.HotelBookingController();
                    return [4 /*yield*/, controller.store({}, {})];
                case 1:
                    store = _a.sent();
                    console.log(store);
                    return [2 /*return*/];
...
//# sourceMappingURL=hotel-booking-controller.test.js.map